...
{
    public class TP145204GB02_RecipientWorkgroupUniversal : NPFIT_000080_Role
    {
        const string TEMPLATEID = "COCD_TP145204GB02";
        const string TEMPLATETEXT = "RecipientWorkgroup";

        internal r_intendedRecipient RecipientRole;

        public TP145204GB02_RecipientWorkgroupUniversal()
            : base()
        {
        ...
        public void SetPersonName(PN_Helper name)
        {
            ...
            RecipientRole.assignedPerson.SetName(name.PN);
        }
        #endregion
