...
{
    public class p_authenticator_000024 : ParticipationClass
    {
        public NPFIT_000024_Role Role { get; set; }

        public p_authenticator_000024()
            : base()
        {
            base.typeCode = "AUTHEN";
        }

        public p_authenticator_000024(TS authenticationTime)
            : base()
        {
            base.typeCode = "AUTHEN";
