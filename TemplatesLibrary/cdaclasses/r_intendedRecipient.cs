...
namespace nhs.itk.hl7v3.cda.classes
{
   ...
   internal class r_intendedRecipient : RoleClass
    {
        ...
        internal r_intendedRecipient()
            : base()
        { }

        internal r_intendedRecipient(string classCode)
            : base(classCode)
        {
        ...
        internal void WriteXml(XmlWriter writer)
        {
            ...
            if (representedOrganisation != null)
            {
                writer.WriteStartElement("receivedOrganization");
