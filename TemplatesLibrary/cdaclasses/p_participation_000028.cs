...
{
    public class p_participation_000028 : ParticipationClass
    {
        public NPFIT_000028_Role Role { set; get; }
        ...
        public p_participation_000028(EncounterParticipationType thisTypeCode)
            : base()
        {
